...
class AopClient {
	//应用ID
	//public $appId = '2018100961623641';
	public $appId = ALIPAY_APPID;
	
	//私钥文件路径
	public $rsaPrivateKeyFilePath;

	//私钥值
	//public $rsaPrivateKey = '';
	public $rsaPrivateKey = ALIPAY_PRIVATE_KEY;
	...
	//使用读取字符串格式，请只传递该值-这里填写支付宝公钥，不是应用公钥
	//public $alipayrsaPublicKey = '';
	public $alipayrsaPublicKey = ALIPAY_PUBLIC_KEY;
