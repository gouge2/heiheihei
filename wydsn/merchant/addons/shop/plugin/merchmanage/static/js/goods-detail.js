    ...
    modal.initClick = function () {
        ...
        $(".btn-submit").unbind('click').click(function () {
            ...
            var obj = {
                ...
                is_fx_goods: modal.checkVal('is_fx_goods') ? 'Y' : 'N',
                fx_profit_money: modal.getVal('fx_profit_money', true),
            ...
            if (obj.dispatchtype == 0) {
                ...
                let ele = $(".dispatchprice")
                if ( ele.length > 2) {
                    ele = $(ele[1])
                }
                obj.dispatchprice = Number(ele.val())
            }
            console.log(obj)
            if (obj.title == '') {
        ...
        $(".submit-params").unbind('click').click(function () {
            ...
            if (action == 'type') {
                ...
                if (dispatchtype == 0) {
                    ...
                    var text = "统一运费 " + Number(ele.val()) + "元"
                }
        ...
        $(document).on('click', '.cate-list nav', function () {
            ...
            children = window.listNav[$(this)[0].getAttribute('index')].sublist
            if ($.isEmptyObject(children)) {
            ...
            $.each(children, function () {
                ...
                HTML += `<nav data-id=' ${ this.cat_id || this.id} '>${this.cat_name || this.name} </nav> `
            });
            console.log(HTML)
        ...
        $(".btn-choose-cate").unbind('click').click(function () {
            ...
            $(".small-block").append('<span class="item" id="only" data-cateid="' + modal.lastcateid + '">' + texts + ' <i class="icon icon-close"></i></span>')
