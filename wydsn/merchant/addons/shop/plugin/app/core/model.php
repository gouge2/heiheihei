                                ...
                                if(!empty($item['data'])) {
                                    ...
                                    if($item['params']['saleout'] == 0 && !empty($_W['shopset']['shop']['saleout'])) {
                                        ...
                                        if(empty($item['params']['saleout'])) {
                                            $item['params']['saleout'] = tomedia('../addons/shop/plugin/diypage/static/images/default/saleout-2.png');
                                        }
                                    } elseif($item['params']['saleout'] == 1 && !empty($item['style']['saleoutstyle'])) {
                                        $item['params']['saleout'] = tomedia('../addons/shop/plugin/diypage/static/images/default/saleout-' . $item['style']['saleoutstyle'] . '.png');
                                    }
                                } else {
                                    unset($page['data']['items'][$itemid]);
                                }
...
//                                        }
                                            ...
                                            foreach ($merchids as $merchid) {
                                                foreach ($merchs as $index => $merch) {
                                                    if ($merch['id'] == $merchid) {
                                                        ...
                                                        $childid = 'C' . $childid;
                                                        if (empty($merch['logo'])){
                                                            $merch['logo'] = tomedia('addons/shop/plugin/diypage/static/images/default/logo.jpg');
                                                        }
                                                        $item['data'][$childid] = array(
                            ...
                            elseif($item['id'] == 'hotarea')
                            {
                                ...
                                $item['params']['default'] = $_W['siteroot'] . '/addons/shop/static/images/';
...
//                    秒杀
        ...
        public function apiFile(){
            $path1 = __DIR__ . '/mobile/shop_api.php';
            $path2 = IA_ROOT . '/app/shop_api.php';
        ...
        public function alipay_build($params, $config = array()){
            ...
            $arr = array(
                ...
                'version' => '1.0',
                'notify_url' => $_W['siteroot'] . 'addons/shop/payment/alipay/notify.php',
