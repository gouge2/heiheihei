...
class Newrelease_EweiShopV2Page extends PluginWebPage
{
	...
	public function main()
	{
		...
		if (is_error($auth)) {
			...
			$test_code = IA_ROOT . '/addons/shop/plugin/app/static/images/test_code_' . $_W['uniacid'] . '.jpg';
			$version_time = 0;
			...
			$wxcode = IA_ROOT . '/addons/shop/plugin/app/static/images/wxcode_' . $_W['uniacid'] . '.jpg';
	...
	public function submit()
	{
		...
		if ($content['status'] != 1) {
			...
			$wxcode = IA_ROOT . '/addons/shop/plugin/app/static/images/test_code_' . $_W['uniacid'] . '.jpg';
