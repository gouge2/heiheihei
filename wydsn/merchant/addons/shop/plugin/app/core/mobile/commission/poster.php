...
class Poster_EweiShopV2Page extends Base_EweiShopV2Page
{
    ...
    public function getimage()
    {
        ...
        $path = IA_ROOT . "/addons/shop/data/poster_wxapp/commission/" . $_W["uniacid"] . "/";
        if( !is_dir($path) ) 
        {
            load()->func("file");
            mkdirs($path);
    ...
    {
        global $_W;
        return $_W["siteroot"] . "addons/shop/data/poster_wxapp/commission/" . $_W["uniacid"] . "/" . $filename . "?v=" . time();
    }
