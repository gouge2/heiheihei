...
if (!class_exists('CommissionModel')) {
    ...
    class CommissionModel extends PluginModel
    {
        ...
        public function getSet($uniacid = 1)
        {
...
//                print_r($where_time);exit;
        ...
        {
            global $_W;
            $path = IA_ROOT . "/addons/shop/data/qrcode/" . $_W['uniacid'];
            if (!is_dir($path)) {
                load()->func('file');
                mkdirs($path);
            }
            ...
            return $_W['siteroot'] . 'addons/shop/data/qrcode/' . $_W['uniacid'] . '/' . $file;
        }
        ...
        public function createGoodsImage($goods)
        {
            ...
            $path = IA_ROOT . "/addons/shop/data/poster/" . $_W['uniacid'] . '/';
            if (!is_dir($path)) {
                load()->func('file');
                mkdirs($path);
            }
            ...
            if (!is_file($path . $file)) {
                ...
                //背景
                $bg = imagecreatefromjpeg(IA_ROOT . '/addons/shop/plugin/commission/static/images/poster.jpg');
            ...
            return $_W['siteroot'] . "addons/shop/data/poster/" . $_W['uniacid'] . "/" . $file;
        }
