    ...
    public function runTasks()
    {
        ...
        if (p('groups')) {
            ...
            if ($groups_order_lasttime + $groups_order_interval <= $groups_order_current) {
                ...
                ihttp_request($_W['siteroot'] . "addons/shop/plugin/groups/task/order.php", null, null, 10);
            }
            /*
             * 拼团失败自动退款
             * */
            ...
            if ($groups_team_lasttime + $groups_team_interval <= $groups_team_current) {
                ...
                ihttp_request($_W['siteroot'] . "addons/shop/plugin/groups/task/refund.php?uniacid={$_W['uniacid']}", null, null, 10);
            }
            /*
             * 拼团发货自动收货
             * */
            ...
            if ($groups_receive_lasttime + $groups_receive_interval <= $groups_receive_current) {
                ...
                ihttp_request($_W['siteroot'] . "addons/shop/plugin/groups/task/receive.php", null, null, 10);
            }
        }
        ...
        if (p('seckill')) {
            ...
            if ($lasttime + $interval <= $current) {
                ...
                ihttp_request($_W['siteroot'] . "addons/shop/plugin/seckill/task/delete.php", null, null, 10);
            }
        }
        //卡密延迟60秒发送
...
//        exit('run finished.');
        ...
        if (p('friendcoupon')) {
            ...
            if ($lasttime + $interval <= $current) {
                ...
                ihttp_request($_W['siteroot'] . "addons/shop/plugin/friendcoupon/task/sendMessage.php?uniacid={$_W['uniacid']}", null, null, 10);
            }
        }
    ...
    public function template($filename = '', $type = TEMPLATE_INCLUDEPATH, $account = false){
        ...
        $name = 'shop';
        $moduleroot = IA_ROOT . "/addons/shop";
