...
//		$ret['engine'] = $result['Engine'];
    ...
    function checkversion() {
        file_put_contents(IA_ROOT . "/addons/shop/version.php", "<?php if(!defined('IN_IA')) {exit('Access Denied');}if(!defined('EWEI_SHOPV2_VERSION')) {define('EWEI_SHOPV2_VERSION', '2.0.0');}if(!defined('EWEI_SHOPV2_RELEASE')) {define('EWEI_SHOPV2_RELEASE', '201605010000');}");
