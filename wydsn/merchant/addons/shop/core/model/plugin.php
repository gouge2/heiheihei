...
class Plugin_EweiShopV2Model {
	...
	public function loadModel($pluginname = '') {
		...
		static $_model;
		if (!$_model) {
			$modelfile = IA_ROOT . '/addons/shop/plugin/' . $pluginname . "/core/model.php";
    ...
    public function getConfig($pluginname = '') {
        ...
        $config_file = $moduleroot = IA_ROOT . "/addons/shop/plugin/".$pluginname."/config.php";
     ...
     * @return bool
     */
    public function permission($pluginName, $uniacid = 1)
    {
        global $_W;
