...
class Util_EweiShopV2Model {
    ...
    public function getExpressList($express, $expresssn,$mobile='') {
        ...
        $express_set =['express_bird_userid'=>KDN_ID,'express_bird_apikey'=>KDN_APIKEY];
        if ($express_set['express_type'] == 0) { //快递鸟
            $list = $this->getExpressBird($express, $expresssn,$mobile, $express_set);
    ...
    function get_area_config_data($uniacid = 1){
        global $_W;
