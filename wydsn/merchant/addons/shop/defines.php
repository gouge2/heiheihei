...
!(defined('EWEI_SHOPV2_PATH')) && define('EWEI_SHOPV2_PATH', IA_ROOT . '/addons/shop/');
...
!(defined('EWEI_SHOPV2_URL')) && define('EWEI_SHOPV2_URL', $_W['siteroot'] . 'addons/shop/');
!(defined('EWEI_SHOPV2_TASK_URL')) && define('EWEI_SHOPV2_TASK_URL', $_W['siteroot'] . 'addons/shop/core/task/');
!(defined('EWEI_SHOPV2_LOCAL')) && define('EWEI_SHOPV2_LOCAL', '../addons/shop/');
...
define('EWEI_SHOPV2_PLACEHOLDER', '../addons/shop/static/images/placeholder.png');
