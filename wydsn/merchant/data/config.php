...
$config['db']['master']['username'] = DB_USER;
$config['db']['master']['password'] = DB_PASSWORD;
$config['db']['master']['port'] = DB_PORT;
$config['db']['master']['database'] = DB_NAME;
$config['db']['master']['charset'] = 'utf8';
$config['db']['master']['pconnect'] = 0;
$config['db']['master']['tablepre'] = 'lailu_';
...
$config['db']['slave']['1']['tablepre'] = 'lailu_';
$config['db']['slave']['1']['weight'] = 0;

$config['db']['common']['slave_except_table'] = array('core_sessions');

// --------------------------  CONFIG COOKIE  --------------------------- //
$config['cookie']['pre'] = '592b_';
...
$config['setting']['authkey'] = 'ef60af0f';
