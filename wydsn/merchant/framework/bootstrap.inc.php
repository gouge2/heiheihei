...
$_W = $_GPC = array();
include IA_ROOT .'/../Public/inc/autoload.php';
...
define('UPLOAD_ROOT', dirname(dirname(dirname(__FILE__))).'/Public/Upload/Goods/images/');
define('UPLOAD_ROOTS', dirname(dirname(dirname(__FILE__))).'/Public/Upload/Goods/');
error_reporting(0);
