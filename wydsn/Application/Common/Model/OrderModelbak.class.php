				...
				if(!$this->create($data)) {
					...
					if($res!==false) {
                        ...
                        if ($goodsMsg['is_gift_goods'] == 'Y'){
                            ...
                            //给一二级推荐人返利的钱
                            $fee_r1=$goodsMsg['price']*$groupMsg['gift_referrer_tate']/10000;
                            //四舍五入
                            $fee_r1=round($fee_r1, 2);
                            $fee_r2=$goodsMsg['price']*$groupMsg['gift_referrer_tate2']/10000;
                            //四舍五入
                            $fee_r2=round($fee_r2, 2);
