                    ...
                    <div class="layui-card-body">
                        <form action="__ACTION__"  class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input class="layui-input" name="exp" placeholder="" style="width: 97%;">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <textarea name="introduce" placeholder="" class="layui-input" style="height:120px;width: 97%;"></textarea>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="width: 120px;">收益比例-用户</label>
                                <div class="layui-input-block">
                                    <input class="layui-input" name="fee_user" value="60" placeholder="" style="width: 97%;">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input class="layui-input" name="fee_service" value="10" placeholder="" style="width: 97%;">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input class="layui-input" name="fee_plantform" value="30" placeholder="" style="width: 97%;">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input class="layui-input" name="self_rate" value="30" placeholder="" >
                                    <span class="help-block m-b-none text-danger">请填写整数，30代表30%</span>
                                </div>
                            </div>
                            -->
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input class="layui-input" name="referrer_rate" value="30" placeholder="" style="width: 97%;">
                                    <span class="help-block m-b-none text-danger">请填写整数，30代表30%</span>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input class="layui-input" name="referrer_rate2" value="30" placeholder="" style="width: 97%;">
                                    <span class="help-block m-b-none text-danger">请填写整数，30代表30%</span>
                                </div>
                            </div>
