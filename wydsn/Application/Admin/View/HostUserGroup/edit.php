        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-title">
                    <h3>当前位置：会员管理 &raquo; 直播带货佣金管理 &raquo; 编辑会员组<a class="pull-right" href="__CONTROLLER__/index">返回上一页 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
            </div>
        </div>
        <div class="layui-row layui-col-space15">
                ...
                <div class="layui-card">
                    <div class="layui-card-body">
                        <form action="__ACTION__/group_id/{$msg['id']}"  class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="width: 120px;">1级团体分红</label>
                                <div class="layui-input-block">
                                    <input class="layui-input" name="team_rate" value="{$msg.team_rate}" placeholder="" style="width: 97%;">
                                    <span class="help-block m-b-none text-danger">请填写整数，30代表30%</span>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="width: 120px;">2级团体分红</label>
                                <div class="layui-input-block">
                                    <input class="layui-input" name="team_rate2" value="{$msg.team_rate2}" placeholder="" style="width: 97%;">
                                    <span class="help-block m-b-none text-danger">请填写整数，10代表10%</span>
                                </div>
                            </div>
