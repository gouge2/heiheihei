...
<head>
    ...
    <script>
        ...
        function deloldimg(jingdong_cat_id) {
            if (jingdong_cat_id != '') {
                swal({
                    title: "确定删除原图标吗？",
                    text: "",
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/taokeyun.php/JingdongCat/deloldimg",
                        dataType: "html",
                        data: "jingdong_cat_id=" + jingdong_cat_id,
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：京东管理系统 &raquo; 京东商品分类管理 &raquo; 编辑京东商品分类<a class="layui-btn pull-right" href="__CONTROLLER__/index" style="margin-top: -10px">返回上一页
            ...
            <div class="layui-col-md12">
                <div class="layui-card">
                    <div class="layui-card-body">
                        <form action="__ACTION__/jingdong_cat_id/{$msg['jingdong_cat_id']}" class="form-horizontal layui-form"
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="width: 145px;">商品关键字</label>
                                <div class="layui-input-block">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input" name="jingdong_id"
                                           value="{$msg.jingdong_id}" placeholder="" style="width: 97%;">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block" style="width: 97%;">
                                    ...
                                    if ($msg['icon']) {
                                        ...
                                        <button class="layui-btn" type="button" onclick="deloldimg(' . $msg['jingdong_cat_id'] . ')">删除原图标</button>';
                                    } else {
                                        echo '暂无';
                                    } ?>
                                </div>
                                ...
                                <div class="layui-input-inline">
                                    <select class="layui-input m-b" name="pid" style="width: 97%;">
                                        ...
                                        foreach ($catlist as $l) {
                                            if (in_array($l['jingdong_cat_id'], $subarr)) {
                                                $disabled = 'disabled="disabled"';
                                            } else {
                                                $disabled = '';
                                            }
                                            //无法选择自身作为父级
                                            if ($l['jingdong_cat_id'] == $msg['jingdong_cat_id']) {
                                                $disabled = 'disabled="disabled"';
                                            }
                                            if ($l['jingdong_cat_id'] == $msg['pid']) {
                                                $select = 'selected';
                                            } else {
                                                $select = '';
                                            }
                                            echo '<option value="' . $l['jingdong_cat_id'] . '" style="margin-left:55px;" ' . $select . ' ' . $disabled . '>' . $l['lefthtml'] . '  ' . $l['name'] . ' ';
                                        }
                                        ?>
                                    </select>
                                </div>
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="width: 145px;">商品获取方式</label>
                                <div>
                                    <div class="layui-input-block" style="width: 97%;">
                                        <input type="radio" name="is_api"
                                               value="Y" <?php if ($msg['is_api'] == 'Y') echo 'checked'; ?> title='接口调用'>
                                        <input type="radio" name="is_api"
                                               value="N" <?php if ($msg['is_api'] == 'N') echo 'checked'; ?> title='关键词搜索'>
                                    </div>
                                </div>
                            </div>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item layui-layout-admin">
                                <div class="layui-input-block">
                                    <button class="layui-btn" type="submit"><i class="fa fa-check"></i>&nbsp;编辑京东商品分类
                                    </button>
