        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：黑卡管理 &raquo; 添加商品<a class="layui-btn pull-right" href="__CONTROLLER__/index" style="margin-top: -10px">返回上一页 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
            </div>
        </div>
        <div class="layui-row layui-col-space15">
                                    ...
                                    <div id="tab-1" class="tab-pane active" style="padding-top: 10px">
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="text" class="layui-input" name="title" value="" placeholder="" style="width: 97%;">
                                            </div>
                                        </div>
                                        <div class="layui-form-item">
                                            <label class="layui-form-label" style="width: 120px;">简单描述</label>
                                            <div class="layui-input-block">
                                                <input type="text" class="layui-input" name="sub_title" style="width: 97%;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="text" class="layui-input" name="url" style="width: 97%;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div>
                                                <div class="layui-input-block">
                                                    <input type="radio" name="status" value="Y" checked title='上架'>
                                                    <input type="radio" name="status" value="N" title='下架'>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="layui-form-item">
                                            ...
                                            <div>
                                                <div class="layui-input-block">
                                                    <input type="radio" name="tequan" value="Y" title='是'>
                                                    <input type="radio" name="tequan" value="N" checked title=’否>
                                                </div>
                                            </div>
                                        </div>
...
<!--                                    </div>-->
                                    <div class="layui-form-item layui-layout-admin">
                                        <div class="layui-input-block">
                                            <button class="layui-btn" type="submit"><i class="fa fa-check"></i>&nbsp;添加商品</button>
