    ...
    <script type="text/javascript">
        ...
        function changestatus(id,status)
        {
            if(id!='') {
                $.ajax({
                    type:"POST",
                    url:"/taokeyun.php/VipCat/changestatus",
                    dataType:"html",
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-title">
                    <h3>当前位置： 唯品会管理系统 &raquo; 唯品会商品分类管理</h3>
                </div>
                <div class="ibox-content">
                    <div class="layui-input-block layui-input-right">
                        <a class="layui-btn pull-right" href="__CONTROLLER__/add">添加唯品会商品分类</a>
                    </div>
                    <div class="layui-row layui-col-space15">
                            ...
                            <table class="layui-table">
                                ...
                                foreach($list as $l) {
                                    ...
                                    echo '<tr>
                                                ...
                                                <td>'.$l['vip_id'].'</td>       		                                    
                                                <td>'.$icon.'</td>
                                                <td><button type="button" class="'.$show_css.'" onclick="changestatus('.$l['vip_cat_id'].',\''.$change_show.'\');">'.$show_str.'</button>
                                                <td class="has-warning"><input name="sort['.$l['vip_cat_id'].']" value="'.$l['sort'].'" class="form-control" style="width:50px;text-align:center"/></td>
       		                                    <td>
		                                            <a href="__CONTROLLER__/edit/vip_cat_id/'.$l['vip_cat_id'].'" title="修改">
			                                             <i class="layui-icon layui-icon-edit" style="font-size:2.0rem"></i>&nbsp;
      		                                        </a>
		                                            <a href="javascript:;" onclick="del('.$l['vip_cat_id'].');" title="删除">
