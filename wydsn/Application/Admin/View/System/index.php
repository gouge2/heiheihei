...
<body class="fixed-sidebar full-height-layout gray-bg layui-layout-body" style="overflow: hidden" >
	<div id="wrapper"  class="layadmin-tabspage-none">
		<!--左侧导航开始-->
		...
		<div id="page-wrapper" style='margin-left:200px'>
			...
			<div class="row J_mainContent gray-bg" id="content-main">
