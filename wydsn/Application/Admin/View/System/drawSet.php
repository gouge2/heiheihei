                        ...
                        <form action="__ACTION__"  class="form-horizontal layui-form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block" style="width: 80%;">
                                    <input type="radio" name="draw_method" value="1" <?php if($msg['draw_method']=='1') echo 'checked'; ?> title="人工审核">
                                    <input type="radio" name="draw_method" value="2" <?php if($msg['draw_method']=='2') echo 'checked'; ?> title="后台审核">
                                    <input type="radio" name="draw_method" value="3" <?php if($msg['draw_method']=='3') echo 'checked'; ?> title="自动转账">
                                    
                                </div>
                                <span class="layui-form-mid layui-word-aux">
                                    人工审核：所有提现申请由后台客服人员人工审核，核实后进行线下转账给用户
                                    <br/>
                                    后台审核：用户申请提现后，由后台客服人员人工审核，审核通过后自动转账给用户提现账号
                                    <br/>
                                    自动转账：用户申请提现后自动转账给用户提现账号，无需人工审核转账
                                    <br/>
                                    目前自动转账仅支持支付宝支付
                                </span>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <span class="layui-form-mid layui-word-aux">单位元，针对 “后台审核/自动转账” 提现方式下设置不超过多少元进行自动转账</span>
                            </div>
                            <div class="layui-form-item">
                                <!--                            <div class="layui-form-item">-->
                                <label class="layui-form-label" style="width: 300px;">自动转账-大额提现后台审核是否自动转账</label>
                                <div class="layui-input-block" style="width: 80%;">
                                    <input type="radio" name="draw_auto_type" value="Y" <?php if($msg['draw_auto_type']=='Y') echo 'checked'; ?> title="是">
                                    <input type="radio" name="draw_auto_type" value="N" <?php if($msg['draw_auto_type']=='N') echo 'checked'; ?> title="否">
                                </div>
                                <span class="layui-form-mid layui-word-aux">针对 “后台审核/自动转账” 提现方式下，超出自动转账金额的大额提现，后台审核通过后是否自动转账</span>     
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="width: 300px;">提现手续费</label>
                                <div class="layui-input-block">

                                    <input type="text" class="layui-input" name="draw_fee" value="{$msg['draw_fee']}" placeholder="" style="width: 69%;">
                                    <label>
                                        <span class="layui-form-mid layui-word-aux">每笔提现订单扣除手续费百分比，如写5表示5%</span>
                                    </label>
                                </div>
                            </div>
