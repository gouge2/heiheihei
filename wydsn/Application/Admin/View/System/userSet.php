                    ...
                    <div class="layui-card-body">
                        <form action="__ACTION__" class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="width: 200px;">推荐注册增加经验值</label>
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input" name="user_upgrade_register"
                                           value="{$msg['user_upgrade_register']}" placeholder="" style="width: 80%;">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="width: 200px;">推荐用户购物增加经验值</label>
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input" name="user_upgrade_buy"
                                           value="{$msg['user_upgrade_buy']}" placeholder="" style="width: 80%;">
                                </div>
                            </div>
