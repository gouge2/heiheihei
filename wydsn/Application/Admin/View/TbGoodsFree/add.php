        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：营销中心 &raquo; 添加淘宝0元购商品<a class="layui-btn pull-right" href="__CONTROLLER__/index" style="margin-top: -10px">返回上一页 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
            </div>
        </div>
        <div class="layui-row layui-col-space15">
                        ...
                        <form action="__ACTION__"  class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block" style="width: 97%;">
                                    ...
                                    <span class="layui-form-mid layui-word-aux">请确保填写的商品为淘宝客活动商品，并且有优惠券</span>
                                </div>
                            </div>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block" style="width: 97%;">
                                    <input class="layui-input" name="subsidy_amount" value="0" placeholder="" >
                                </div>
                            </div>
                            <div class="layui-form-item">
