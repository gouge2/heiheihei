        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：商城系统 &raquo; 发票信息管理 &raquo; 编辑发票<a class="layui-btn pull-right" href="__CONTROLLER__/index" style="margin-top: -10px">返回上一页 <i
            ...
            <div class="layui-col-md12">
                <div class="layui-card">
                    <div class="layui-card-body">
                        <form action="__ACTION__/invoice_id/{$msg.invoice_id}" class="form-horizontal layui-form" method="post"
                              enctype="multipart/form-data">
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="width: 100px;">发票类型</label>
                                <div>
                                    <div class="layui-input-block">
                                        <input type="radio" name="type" value="1" <?php if ($msg['type'] == '1') {
                                            echo 'checked';
                                        } ?> title='企业'>
                                        <input type="radio" name="type" value="2" <?php if ($msg['type'] == '2') {
                                            echo 'checked';
                                        } ?> title='个人'>
                                    </div>
                                </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input" name="purchaser" value="{$msg.purchaser}"
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input" name="taxpayer_id"
                                           value="{$msg.taxpayer_id}" placeholder="请输入企业纳税人识别号">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="width: 100px;">开户行</label>
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input" name="bank" value="{$msg.bank}"
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input" name="account" value="{$msg.account}"
                                           placeholder="请填写账号">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input" name="contact" value="{$msg.contact}"
                                           placeholder="请填写联系电话">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input" name="address" value="{$msg.address}"
                                           placeholder="请填写收件地址">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input" name="linkman" value="{$msg.linkman}"
                                           placeholder="请填写收件人">
                                </div>
                            </div>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item layui-layout-admin">
                                <div class="layui-input-block">
                                    <button class="layui-btn" type="submit"><i class="fa fa-check"></i>&nbsp;编辑发票
                                    </button>
