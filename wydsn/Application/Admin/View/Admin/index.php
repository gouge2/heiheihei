                ...
                <div class="ibox-content">
                    <form action="__ACTION__" method="get" role="form" class="form-inline pull-left">
                        ...
                        <div class="layui-inline">
                            <label class="layui-form-label" style="width: 220px;">管理员用户名、邮箱、手机号码：</label>
                            <div class="layui-input-inline">
                                <input type="text" placeholder="" name="search" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
                            <label class="layui-form-label" style="width: 50px;">组名</label>
                            <div class="layui-input-inline">
                                <input type="text" placeholder="" name="group_name" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
                            <button class="layui-btn layuiadmin-btn-admin" lay-submit lay-filter="LAY-user-back-search">
