                            ...
                            <div class="layui-form-item">
                                ...
                                <div>
                                    <div class="layui-input-block" style="width: 97%;">
                                        <input type="radio" name="tk_status" value="" checked title='全部'>
                                        <input type="radio" name="tk_status" value="12" title='付款'>
                                        <input type="radio" name="tk_status" value="13" title='关闭'>
                                        <input type="radio" name="tk_status" value="14" title='确认收货'>
                                        <input type="radio" name="tk_status" value="3" title='结算成功'>
                                    </div>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div>
                                    <div class="layui-input-block" style="width: 97%;">
                                        <input type="radio" name="order_scene" value="1" checked title='常规订单'>
                                        <input type="radio" name="order_scene" value="2" title='渠道订单'>
                                        <input type="radio" name="order_scene" value="3" title='会员订单（目前不用）'>
                                    </div>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div>
                                    <div class="layui-input-block" style="width: 97%;">
                                        <input type="radio" name="query_type" value="1" title='创建时间'>
                                        <input type="radio" name="query_type" value="2" checked title='付款时间'>
                                        <input type="radio" name="query_type" value="3" title='结算时间'>
                                    </div>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    ...
                                    ?>
                                    <input type="text" class="layui-input" name="time" id="date" placeholder="{$data}" value="{$data}">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div>
                                    <div class="layui-input-block" style="width: 97%;">
                                        <input type="radio" name="member_type" value="" checked title='所有角色'>
                                        <input type="radio" name="member_type" value="2" title='二方'>
                                        <input type="radio" name="member_type" value="3" title='三方'>
                                    </div>
                                </div>
                            </div>
