                            ...
                            <div class="layui-form-item">
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" name="trade_id" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-inline">
                                    <label class="layui-form-label" style="width:60px;">商品名称</label>
                                    <div class="layui-input-inline">
                                        <input type="text" name="item_title" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                                <div class="layui-inline">
                                ...
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline">
                                        <select class="form-control" name="tk_status">
                                            <option value="">请选择订单状态</option>
                                            <option value="3">订单结算</option>
                                            <option value="12">订单付款</option>
                                            <option value="13">订单失效</option>
                                ...
                                <div class="layui-inline">
                                    <label class="layui-form-label" style="width: 80px;">是否维权</label>
                                    <div class="layui-input-inline">
                                        <select class="form-control" name="is_refund">
                                            <option value="">请选择</option>
                                            <option value="Y">是</option>
                                            <option value="N">否</option>
                                        </select>
                        ...
                        <table class="layui-table">
                            ...
                            ?>
                                <foreach name="list" item="l">
                                    <tr>
                                        <td><img src="{$l['item_img']}" height="50"></td>
                                        <td>{$l['trade_id']}</td>
                                        <td>{$l['item_title']}</td>
                                        ...
                                        if ($l['tk_status'] == '3') {
                                            if ($l['is_refund'] == 'Y') {
                                                ...
                                                echo '<a href="__CONTROLLER__/refund/id/' . $l['id'] . '" title="维权处理">维权处理</a>';
                                            }
                                        }
                                        ?>
                                        </td>
