            ...
            $('#batchdel').click(function(){
                ...
                if(all_id!='') {
                    swal({
                        ...
                        $.ajax({
                            type:"POST",
                            url:"/taokeyun.php/GoodsImg/batchdel",
                            dataType:"html",
                            data:"all_id="+all_id,
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置： 商品管理 &raquo; {$goods_name} &raquo; 商品图片列表<a class="layui-btn pull-right" href="__MODULE__/Goods/index/cat_id/{$cat_id}" style="margin-top: -10px">返回商品列表 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
                <div class="ibox-content">
                    <a class="layui-btn btn-primary pull-right" href="__CONTROLLER__/add/goods_id/{$goods_id}/cat_id/{$cat_id}">添加商品图片</a>
                    <div class="layui-row layui-col-space15">
                        <form action="__CONTROLLER__/changesort/goods_id/{$goods_id}" method="post">
                            <table class="layui-table">
                                ...
                                <tr>
                                    <td colspan="8">
                                        <input type="submit" class="layui-btn btn-primary" value="统一排序">
                                        <input type="button" class="layui-btn btn-primary" id="unselect" value="取消选择">
                                        <input type="button" class="layui-btn btn-primary" id="selectall" value="全选">
                                        <input type="button" class="layui-btn btn-primary" id="batchdel" value="批量删除">
                                    </td>
                                </tr>
                                </tbody>
                            </table>
