                ...
                <div class="ibox-content">
                    <form action="__ACTION__" method="get" role="form" class="form-inline pull-left">
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label" style='width:180px'>淘宝官方商品分类名称</label>
                            <div class="layui-input-inline">
                                <input type="text" name="category_name" required  lay-verify="required"  autocomplete="off" class="layui-input">
                            </div>
                            <div class="layui-input-inline">
