        ...
        function deloldimg(cat_id) {
            if (cat_id != '') {
                swal({
                    ...
                    $.ajax({
                        type: "POST",
                        url: '/taokeyun.php/GoodsCat/deloldimg',
                        dataType: "html",
                        data: "cat_id=" + cat_id,
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：商品管理 &raquo; 编辑商品分类<a class="layui-btn pull-right" href="__CONTROLLER__/index" style="margin-top: -10px">返回上一页 <i
            ...
            <div class="layui-col-md12">
                <div class="layui-card">
                    <div class="layui-card-body">
                        ...
                        <form action="__ACTION__/cat_id/{$msg['cat_id']}" class="form-horizontal layui-form" method="post"
                            ...
                            <div class="tab-content">
                                ...
                                <div id="tab-1" class="tab-pane active" style="padding-top: 10px">
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" class="layui-input" name="cat_name"
                                                   value="{$msg['cat_name']}" placeholder="">
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <button class="layui-btn" type="button" onclick="deloldimg(' . $msg['cat_id'] . ')">删除原图片</button>';
                                            } else {
                                                echo '暂无';
                                            } ?>
                                        </div>
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" class="layui-input" name="keywords"
                                                   value="{$msg['keywords']}" placeholder="">
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <textarea name="description" placeholder="" class="layui-input"
                                                      style="height:100px;">{$msg['description']}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <!-- 商品分类基本信息  -->
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <script name="content" id="editor" type="text/plain"
                                                    style="height:300px;"><?php echo htmlspecialchars_decode(html_entity_decode($msg['content'])); ?></script>
                                        </div>
                                    </div>
                                </div>
                                <!-- 商品分类详情  -->
                                ...
                                <div class="layui-form-item layui-layout-admin">
                                    <div class="layui-input-block">
                                        <button class="layui-btn" type="submit"><i class="fa fa-check"></i>&nbsp;编辑商品分类
                                        </button>
