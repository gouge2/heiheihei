            ...
            $('#batchdel').click(function(){
                ...
                if(all_id!='') {
                    swal({
                        ...
                        $.ajax({
                            type:"POST",
                            url:"/taokeyun.php/TbGoods/batchdel",
                            dataType:"html",
                            data:"all_id="+all_id,
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="ibox-content">
                    ...
                    <form action="__ACTION__" method="get" role="form" class="form-inline pull-left" style='margin-top:10px'>
...
<!--                        <button class="btn btn-primary" type="submit">查询</button>-->
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="tel" name="goods_name" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
                    ...
                    <a class="layui-btn pull-right" href="__CONTROLLER__/set"  style="margin-right: 5px"><i class="fa fa-check"></i>&nbsp;更新淘宝商品</a>
                    <div class="layui-row layui-col-space15">
