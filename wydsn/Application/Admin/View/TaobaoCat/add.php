        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：淘宝管理系统 &raquo; 淘宝商品分类管理 &raquo; 添加淘宝商品分类<a class="layui-btn pull-right" href="__CONTROLLER__/index" style="margin-top: -10px">返回上一页
                    ...
                    <div class="layui-card-body">
                        <form action="__ACTION__" class="form-horizontal layui-form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input" name="tb_cat_id" placeholder=""
                                           style="width: 97%;">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <select class="layui-input m-b" name="pid" style="width: 97%;">
                                        ...
                                        foreach ($catlist as $l) {
                                            echo '<option value="' . $l['taobao_cat_id'] . '" style="margin-left:55px;">' . $l['lefthtml'] . '  ' . $l['name'] . ' ';
                                        }
                                        ?>
                                    </select>
                                </div>
                            ...
                            <div class="layui-form-item layui-layout-admin">
                                <div class="layui-input-block">
                                    <button class="layui-btn" type="submit"><i class="fa fa-check"></i>&nbsp;添加淘宝商品分类
                                    </button>
