        ...
        function deloldimg(taobao_cat_id) {
            if (taobao_cat_id != '') {
                swal({
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/taokeyun.php/TaobaoCat/deloldimg",
                        dataType: "html",
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：淘宝管理系统 &raquo; 淘宝商品分类管理 &raquo; 编辑淘宝商品分类<a class="layui-btn pull-right" href="__CONTROLLER__/index" style="margin-top: -10px">返回上一页
            ...
            <div class="layui-col-md12">
                <div class="layui-card">
                    <div class="layui-card-body">
                        <form action="__ACTION__/taobao_cat_id/{$msg['taobao_cat_id']}" class="form-horizontal layui-form"
