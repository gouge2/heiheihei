    ...
    <script>
        function changeIndexShow(id,status)
        {
            if(id!='')
            {
                $.ajax({
                    type:"POST",
                    url:'/taokeyun.php/DiyModule/changeIndexShow',
                    dataType:"html",
        ...
        function changeIsLink(id,status)
        {
            if(id!='')
            {
                $.ajax({
                    type:"POST",
                    url:'/taokeyun.php/DiyModule/changeIsLink',
                    dataType:"html",
                    data:"id="+id+"&status="+status,
                    success:function(msg)
                    {
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="ibox-content">
                    <!-- <a class="layui-btn pull-left" href="https://www.taokeyun.cn/shijianbiao.png" target="_blank">查看已有功能模块</a> -->
                        ...
                        <form action="__CONTROLLER__/changesort" method="post">
                            <table class="layui-table">
                                ...
                                <tr>
                                    ...
                                    <th>功能模块名称</th>
                                    <th>是否外链接</th>
                                    <th><div style="width: 200px">功能模块链接</div></th>
                                    <th>功能模块图标</th>
                                    <th>首页是否显示</th>
                                    <th>排序</th>
                                    <th>操作</th>
                                ...
                                <foreach name="list" item="l">
                                    <tr>
                                        ...
                                        <td><div style="width: 200px;box-sizing:border-box;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;">{$l['link']}</div></td>
