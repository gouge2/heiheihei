        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：管理员管理 &raquo; 组别管理 &raquo; 编辑管理员组<a class="layui-btn pull-right" href="__CONTROLLER__/index" style="margin-top: -10px">返回上一页 <i
            ...
            <div class="layui-col-md12">
                <div class="layui-card">
                    <div class="layui-card-body">
                        <form action="__ACTION__/group_id/{$msg['id']}" class="form-horizontal layui-form" method="post"
                              enctype="multipart/form-data">
                            <div class="layui-form-item">
                                <label class="layui-form-label" >管理员组名</label>
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label" >组别描述</label>
                                <div class="layui-input-block">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    ...
                                    foreach ($rlist as $r) {
                                        ...
                                        //             <input type="checkbox" name="rules[]" value="' . $rid . '" ' . $check . ' title="' . $r['title'] . '"> 
                                        //           </div>';
                                        echo '<input type="checkbox" name="rules[]" value="' . $rid . '" ' . $check . ' title="' . $r['title'] . '">';
                                    }
                                    ?>
                                </div>
                            </div>
