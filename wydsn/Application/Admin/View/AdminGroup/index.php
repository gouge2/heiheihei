            ...
            <div class="layui-card">
                ...
                <div class="ibox-content">
                    <div class="layui-input-block layui-input-right">
                        <a class="layui-btn pull-right" href="__CONTROLLER__/addgroup">添加管理员组</a>
                    </div>
                    <div class="layui-row layui-col-space15">
                        <table class="layui-table">
                            ...
                            <foreach name="glist" item="g">
                                <tr>
                                    ...
                                    <td>
                                        <if condition='$g[status] eq 1'>
                                            <button type="button" class="layui-btn layui-btn-xs"
                                                    onclick="changestatus({$g.id},0);">开启
                                            </button>
                                            <else/>
                                            <button type="button" class="layui-btn layui-btn-primary layui-btn-xs"
                                                    onclick="changestatus({$g.id},1);">关闭
                                            </button>
                                        </if>
                                    </td>
                                    <td>{$g['create_time']}</td>
                                    ...
                                    <td><a href="__MODULE__/Admin/index/group_id/{$g.id}" class="layui-btn">点击查看用户列表</a></td>
                                    <td>
