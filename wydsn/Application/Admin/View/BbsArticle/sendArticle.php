                        ...
                        <form action="__ACTION__"  class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    ...
                                    <span class="layui-form-mid layui-word-aux">请填写正确的网址，否则无法在App中打开</span>
                                    <span class="layui-form-mid layui-word-aux">本地文章网址：网址/IP地址+/wap.php/System/article1/id/28，最后的文章ID=28请替换</span>
                                </div>
                            </div>
