    ...
    <script type="text/javascript">
            ...
            $('#batchdel').click(function(){
                ...
                if(all_id!='') {
                    swal({
                        ...
                        $.ajax({
                            type:"POST",
                            url:"/taokeyun.php/BbsArticle/batchdel",
                            dataType:"html",
                            data:"all_id="+all_id,
            ...
            $('#transfer').click(function(){
                ...
                if(all_id!='') {
                    ...
                    swal({
                        ...
                        $.ajax({
                            type:"POST",
                            url:"/taokeyun.php/BbsArticle/transfer",
                            dataType:"html",
        ...
        function changeshow(id,status)
        {
            if(id!='')
            {
                $.ajax({
                    type:"POST",
                    url:'/taokeyun.php/BbsArticle/changeshow',
                    dataType:"html",
        ...
        function del(id)
        {
            if(id!='') {
                swal({
                    ...
                    $.ajax({
                        type:"POST",
                        url:'/taokeyun.php/BbsArticle/del',
                        dataType:"html",
                        data:"id="+id,
                        success:function(msg)
                        {
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置： 论坛系统 &raquo; 帖子管理 &raquo; 已审核帖子列表<a class="layui-btn pull-right" href="__MODULE__/BbsBoard/index" style="margin-top: -10px">返回版块管理 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
                <div class="ibox-content">
                    <if condition="$board_id == 1">
                        <a class="layui-btn pull-left" id="checkSet" href="javascript:;">商品来源配置</a>
                    </if>
                        ...
                        <table class="layui-table">
                            ...
                            <foreach name="list" item="l">
                                <tr>
                                    ...
                                    <td>{$l['pubtime']}</td>
                                    <td>
                                        <a href="__CONTROLLER__/edit/id/{$l.id}/board_id/{$l.board_id}" title="审核/查看详情">
...
<script type="text/javascript">
    layui.use('layer', function(){ //独立版的layer无需执行这一句
        ...
        $('#checkSet').click(function () {
            layer.open({
                type: 2,
                content: '__MODULE__/BbsArticle/checkSet',
                title: '商品来源配置',
                area: ['300px', '280px'],
                btn: ['立即提交', '取消'],
                yes: function(index, layero) {
                    ...
                    iframeWindow.layui.form.on('submit('+ submitID +')', function(data) {
                        ...
                        // 请求提交
                        $.ajax({
                            url: '__MODULE__/BbsArticle/checkSet',
                            type: 'post',
                            data: field,
                            dataType : 'JSON',
