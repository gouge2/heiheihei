        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：订单管理 &raquo; 处理已付款订单<a class="layui-btn pull-right" href="__CONTROLLER__/paid" style="margin-top: -10px">返回已付款订单 <i
                            ...
                            <div class="tab-content">
                                ...
                                <div id="tab-1" class="tab-pane active" style="padding-top: 10px">
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" class="layui-input" name="express_number" value="{$msg['express_number']}" placeholder="">
                                        </div>
                                        <div class="layui-form-mid layui-word-aux">请填写快递单号便于会员查看物流</div>
                                    </div>
                                    <div class="layui-form-item">
                                        <label class="layui-form-label" style="width: 100px;">订单状态</label>
                                        <div class="layui-input-block">
                                            <select class="layui-input m-b" name="status">
                                                <option value="2" <?php if ($msg['status'] == '2') {
                                                    echo 'selected';
                                                } ?> >已支付
                                                </option>
                                                <option value="3" <?php if ($msg['status'] == '3') {
                                                    echo 'selected';
                                                } ?> >确认发货
                                                </option>
                                            </select>
