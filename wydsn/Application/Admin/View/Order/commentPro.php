        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：订单管理 &raquo; 查看已评价/已结束订单<a class="layui-btn pull-right" href="__CONTROLLER__/comment" style="margin-top: -10px">返回已评价/已结束订单 <i
                            ...
                            <div class="tab-content">
                                ...
                                <div id="tab-1" class="tab-pane active" style="padding-top: 10px">
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" class="layui-input" name="" value="已评价、已完成"
                                    ...
                                    <div class="layui-form-item">
                                        <label class="layui-form-label" style="width: 100px;">确认收货时间</label>
                                        <div class="layui-input-block">
                                            <input type="text" class="layui-input" name="" value="{$msg.finish_time}"
                                                   disabled>
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                        <label class="layui-form-label" style="width: 100px;">评价时间</label>
                                        <div class="layui-input-block">
                                            <input type="text" class="layui-input" name="" value="{$msg.comment_time}"
                                                   disabled>
                                        </div>
                                    </div>
                                </div>
