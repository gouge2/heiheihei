        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：订单管理 &raquo; 审核申请退款订单<a class="layui-btn pull-right" href="__CONTROLLER__/refund" style="margin-top: -10px">返回申请退款订单列表 <i
                        ...
                        <form action="__ACTION__/id/{$msg.id}" class="form-horizontal" method="post"
                            ...
                            <div class="tab-content">
                                ...
                                <div id="tab-1" class="tab-pane active" style="padding-top: 10px">
                                    ...
                                    <div class="layui-form-item">
                                        <label class="layui-form-label" style="width: 100px;">是否同意退款</label>
                                        <div>
                                            <div class="radio i-checks">
                                                <input type="radio" name="check_result" value="Y" checked> <i></i>同意
                                                <input type="radio" name="check_result" value="N"> <i></i>拒绝
                                            </div>
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
