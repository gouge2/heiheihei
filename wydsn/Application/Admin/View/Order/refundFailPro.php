        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：订单管理 &raquo; 拒绝退款订单<a class="layui-btn pull-right" href="__CONTROLLER__/refundFail" style="margin-top: -10px">返回拒绝退款订单列表 <i
                                ...
                                <div id="tab-1" class="tab-pane active" style="padding-top: 10px">
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input type="text" class="layui-input" name="title" value="{$msg['title']}"
                                                   placeholder="">
                                            <span class="layui-form-mid layui-word-aux">必填</span>
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            ...
                                            <span class="layui-form-mid layui-word-aux">请填写快递单号便于会员查看物流</span>
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                    ...
                                    <div class="layui-form-item">
                                        <label class="layui-form-label" style="width: 100px;">拒绝退款时间</label>
                                        <div class="layui-input-block">
                                            <input type="text" class="layui-input" name="refund_fail_time"
                                                   value="{$msg.refund_fail_time}" disabled>
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                        <label class="layui-form-label" style="width: 100px;">拒绝退款理由</label>
                                        <div class="layui-input-block">
                                            <textarea name="drawback_refuse_reason" placeholder="" class="layui-input"
                                                      style="height:80px;">{$msg.drawback_refuse_reason}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <!-- 订单基本信息  -->
