        ...
        <div class="layui-col-md12">
            <div class="layui-card">
					<div class="ibox-content">
						<h3>当前位置： 商品管理 &raquo; 商品SKU配置 &raquo; {$GoodsMsg.goods_name}<a class="layui-btn pull-right" href="__MODULE__/Goods/index/cat_id/{$GoodsMsg.cat_id}" style="margin-top: -10px">返回商品列表 <i class="fa fa-angle-double-right"></i></a></h3>
					</div>
					<div class="ibox-content">
						<div class="">
		   ...
		   <td><input type="file" name="img[]" accept="image/*" value="" />'.$img_str.'</td>
		 </tr>';
    								}
    								?>
									<tr>
										<td colspan="<?php echo $attribute_num+5;?>">
	        								<input type="reset" class="layui-btn btn-primary pull-right" value="重置">
	        								<input type="submit" class="layui-btn btn-primary pull-right" style="margin-right:10px" value="确认配置">
