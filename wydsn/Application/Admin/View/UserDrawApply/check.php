        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：资金管理 &raquo; 审核用户提现申请<a class="layui-btn pull-right" href="__CONTROLLER__/checkPending" style="margin-top: -10px">返回待审核用户提现申请<i
                ...
                <div class="layui-card">
                    <div class="layui-card-body" style="overflow:hidden">
                        ...
                        <form action="__ACTION__/user_draw_apply_id/{$msg['user_draw_apply_id']}"
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="width: 145px;">手续费</label>
                                <div class="layui-input-block">
                                    <input class="layui-input" placeholder="" value="￥{$msg.draw_fee}" style="width: 97%;" disabled>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="width: 145px;">到账金额</label>
                                <div class="layui-input-block">
                                    <input class="layui-input" placeholder="" value="￥{$msg.real_money}" style="width: 97%;" disabled>
                                </div>
                            </div>
                            <div class="layui-form-item">
