            ...
            <div class="layui-card">
                ...
                <div class="ibox-content">
                    <form action="__ACTION__" method="get" role="form" class="form-inline pull-left">
                        ...
                        开始时间：<input type="text" placeholder="" name="begin_time" class="form-control layer-date"
                                    onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
                        结束时间：<input type="text" placeholder="" name="end_time" class="form-control layer-date"
                                    onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
