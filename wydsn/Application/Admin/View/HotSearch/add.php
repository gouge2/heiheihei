        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：营销中心 &raquo; 热门搜索设置 &raquo; 添加热门搜索行<a class="layui-btn pull-right" href="__CONTROLLER__/index" style="margin-top: -10px">返回上一页 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
            </div>
        </div>
        <div class="layui-row layui-col-space15">
                    ...
                    <div class="layui-card-body">
                        <form action="__ACTION__"  class="form-horizontal layui-form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block" >
                                    <input class="layui-input" name="num" placeholder="" >
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div>
                                    <div class="layui-input-block" >
                                        <input type="radio" name="type" value="1" checked title='淘宝'>
                                        <input type="radio" name="type" value="2" title='拼多多'>
                                        <input type="radio" name="type" value="3" title='京东'>
                                        <input type="radio" name="type" value="4" title='自营商城'>
                                    </div>
                                </div>
                            </div>
