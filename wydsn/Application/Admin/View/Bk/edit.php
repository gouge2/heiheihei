        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：内容管理 &raquo; 宫格管理 &raquo; 编辑图片<a class="layui-btn pull-right" href="__CONTROLLER__/index/cat_id/{$cat_id}" style="margin-top: -10px">返回宫格列表 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
            </div>
        </div>
        <div class="layui-row layui-col-space15">
                    ...
                    <div class="layui-card-body">
                        <form action="__ACTION__/id/{$id}/cat_id/{$cat_id}"  class="form-horizontal layui-form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <?php if($msg['img']){echo '<img src="'.$msg['img'].'" height="200"/>';}else {echo '暂无';} ?>
                                </div>
                            </div>
                            <div class="layui-form-item">
...
<!--                            </div>-->
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="width: 100px;">URL链接</label>
                                <div class="layui-input-block">
