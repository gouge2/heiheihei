        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：内容管理 &raquo; 宫格管理 &raquo; {$cat_title} &raquo; 添加图片<a class="layui-btn pull-right" href="__CONTROLLER__/index/cat_id/{$cat_id}" style="margin-top: -10px">返回宫格列表 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
            </div>
        </div>
        <div class="layui-row layui-col-space15">
...
<!--                            </div>-->
                            <div class="layui-form-item">
                                ...
                                <div>
                                    <div class="layui-input-block">
<!--                                        <input type="radio" name="type" value="1" checked title="网页"/>-->
...
<!--                                        <input type="radio" name="type" value="11" title="0元购"/>-->
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="radio" name="is_show" value="Y" title="是" checked>
                                    <input type="radio" name="is_show" value="N" title="否">
                                </div>
                            </div>
