        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：多商户&raquo; 多语言&raquo; 增加<?= $_GET['client']?>平台  <?= $_GET['name'] ?>语言<a class="layui-btn pull-right" href="javascript:;" onClick="javascript :history.back(-1);" style="margin-top: -10px">返回上一页 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
            </div>
        </div>
        <div class="layui-row layui-col-space15">
            <div class="layui-col-md12">
                <div class="layui-card">
                    <div class="layui-card-body">
                        <form action="__MODULE__/MultiLanguage/addLangAction" onSubmit="return check(this);" class="form-horizontal layui-form " class="layui-form" method="post" enctype="multipart/form-data">
                            <input type="hidden" value="<?= $_GET['lang_sign']?>" name="lang_sign" />
                            <input type="hidden" value="<?= $_GET['cid']?>" name="country_id" />
                            <input type="hidden" value="<?= $_GET['client']?>" name="client" />
                            <hr />
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input class="layui-input" data-text='<?= $v?>'  name="lang[<?= $k ?>]" placeholder="请输入目标国家语言" style="width: 30%;"   />
                                    <div style="width: 94%;color: red">{$error1}</div>
                                </div>
                            </div>
                            <?php endforeach;?>
