        ...
        function deloldimg(pdd_cat_id) {
            if (pdd_cat_id != '') {
                swal({
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/taokeyun.php/PddCat/deloldimg",
                        dataType: "html",
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：拼多多管理系统 &raquo; 拼多多商品分类管理 &raquo; 编辑拼多多商品分类<a class="layui-btn pull-right"
                                                                           href="__CONTROLLER__/index" style="margin-top: -10px">返回上一页 <i
            ...
            <div class="layui-col-md12">
                <div class="layui-card">
                    <div class="layui-card-body">
                        <form action="__ACTION__/pdd_cat_id/{$msg['pdd_cat_id']}" class="form-horizontal layui-form" method="post"
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="width: 145px;">拼多多官方分类ID</label>
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input" name="pdd_id" value="{$msg.pdd_id}"
                                           placeholder="" style="width: 97%;">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block" style="width: 97%;">
                                    ...
                                    if ($msg['icon']) {
                                        ...
                                        <button class="layui-btn" type="button" onclick="deloldimg(' . $msg['pdd_cat_id'] . ')">删除原图标</button>';
                                    } else {
                                        echo '暂无';
                                    } ?>
                                </div>
                                ...
                                <div class="layui-input-inline">
                                    <select class="layui-input m-b" name="pid" style="width: 97%;">
                                        ...
                                        foreach ($catlist as $l) {
                                            if (in_array($l['pdd_cat_id'], $subarr)) {
                                                $disabled = 'disabled="disabled"';
                                            } else {
                                                $disabled = '';
                                            }
                                            //无法选择自身作为父级
                                            if ($l['pdd_cat_id'] == $msg['pdd_cat_id']) {
                                                $disabled = 'disabled="disabled"';
                                            }
                                            if ($l['pdd_cat_id'] == $msg['pid']) {
                                                $select = 'selected';
                                            } else {
                                                $select = '';
                                            }
                                            echo '<option value="' . $l['pdd_cat_id'] . '" style="margin-left:55px;" ' . $select . ' ' . $disabled . '>' . $l['lefthtml'] . '  ' . $l['name'] . ' ';
                                        }
                                        ?>
                                    </select>
                                </div>
                            ...
                            <div class="layui-form-item layui-layout-admin">
                                <div class="layui-input-block">
                                    <button class="layui-btn" type="submit"><i class="fa fa-check"></i>&nbsp;编辑拼多多商品分类
                                    </button>
