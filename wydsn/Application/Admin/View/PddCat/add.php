        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：拼多多管理系统 &raquo; 拼多多商品分类管理 &raquo; 添加拼多多商品分类<a class="layui-btn pull-right"
                    ...
                    <div class="layui-card-body">
                        <form action="__ACTION__" class="form-horizontal layui-form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input" name="keyword" placeholder=""
                                           style="width: 97%;">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" class="layui-input" name="pdd_id" placeholder=""
                                           style="width: 97%;">
                                </div>
                            </div>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div>
                                    <div class="layui-input-block" style="width: 97%;">
                                        <input type="radio" name="is_api" value="Y" checked title='接口调用'>
                                        <input type="radio" name="is_api" value="N" title='关键词搜索'>
                                    </div>
                                </div>
                            </div>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item layui-layout-admin">
                                <div class="layui-input-block">
                                    <button class="layui-btn" type="submit"><i class="fa fa-check"></i>&nbsp;添加拼多多商品分类
                                    </button>
