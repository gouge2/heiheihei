        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：内容管理 &raquo; {$article_title} &raquo; 添加图片<a class="layui-btn pull-right" href="__CONTROLLER__/Index/article_id/{$article_id}/cat_id/{$cat_id}" style="margin-top: -10px">返回图片列表 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
            </div>
        </div>
        <div class="layui-row layui-col-space15">
