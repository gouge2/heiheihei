...
<!--                        <button class="btn btn-primary" type="submit">查询</button>-->
                        <div class="layui-inline">
                            <label class="layui-form-label" style='width:100px'>搜索拉新活动</label>
                            <div class="layui-input-inline">
                                <input type="text" placeholder="" name="search" value="{$search}" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
                        ...
                        <table class="layui-table">
                            ...
                            <foreach name="data" item="value">
                                <tr>
                                    ...
                                    <td><a href="__CONTROLLER__/reward?id={$value.id}" class="layui-btn">奖励设置</a></td>
                                    <td><a href="/taokeyun.php/RookieRecord/index?id={$value.id}" class="layui-btn">兑现记录</a></td>
                                    <td>
