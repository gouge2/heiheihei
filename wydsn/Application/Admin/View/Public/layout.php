...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow: hidden">
	<div id="wrapper">
		...
		<div id="page-wrapper" class="gray-bg dashbard-1" >
			...
			<div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="__MODULE__/System/index" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
			<!-- <div class="row J_mainContent" id="content-main">
			{__CONTENT__}
			</div> -->
	...
	<!-- <script src="__ADMIN_JS__/plugins/layer/layer.all.js"></script> -->
