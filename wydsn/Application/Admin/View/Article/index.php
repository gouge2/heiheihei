    ...
    <script type="text/javascript">
            ...
            $('#batchdel').click(function(){
                ...
                if(all_id!='') {
                    swal({
                        ...
                        $.ajax({
                            type:"POST",
                            url:"/taokeyun.php/Article/batchdel",
                            dataType:"html",
                            data:"all_id="+all_id,
            ...
            $('#transfer').click(function(){
                ...
                if(all_id!='') {
                    ...
                    swal({
                        ...
                        $.ajax({
                            type:"POST",
                            url:"/taokeyun.php/Article/transfer",
                            dataType:"html",
        ...
        function changeshow(id,status)
        {
            if(id!='')
            {
                $.ajax({
                    type:"POST",
                    url:'/taokeyun.php/Article/changeshow',
                    dataType:"html",
        ...
        function changetop(id,status)
        {
            if(id!='')
            {
                $.ajax({
                    type:"POST",
                    url:'/taokeyun.php/Article/changetop',
                    dataType:"html",
                    data:"id="+id+"&status="+status,
                    success:function(msg)
                    {
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置： 内容管理 &raquo; 文章管理 &raquo; {$cname}<a class="layui-btn pull-right" href="__MODULE__/ArticleCat/index" style="margin-top: -10px">返回文章分类列表 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
                <div class="ibox-content">
                            ...
                            <table class="layui-table">
                                ...
                                <foreach name="articlelist" item="a">
                                    <tr>
                                        ...
                                        <td>{$a['clicknum']}</td>
                                        <td>{$a['pubtime']}</td>
                                        <td><a href="__MODULE__/ArticleImg/index/article_id/{$a.article_id}/cat_id/{$cat_id}" class="layui-btn">查看图片列表</a></td>
                                ...
                                <tr>
                                    <td colspan="10">
                                        ...
                                        <div class=" pull-right"  style="display: flex">
                                            ...
                                            <input type="button" class="layui-btn" id="transfer" value="确定转移" >
                                        </div>
                                    </td>
                                </tr>
                                </tbody>
