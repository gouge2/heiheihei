        ...
        function deloldimg(article_id)
        {
            if(article_id!='') {
                swal({
                    ...
                    $.ajax({
                        type:"POST",
                        url:'/taokeyun.php/Article/deloldimg',
                        dataType:"html",
        ...
        function deloldbigimg(article_id)
        {
            if(article_id!='') {
                swal({
                    ...
                    $.ajax({
                        type:"POST",
                        url:'/taokeyun.php/Article/deloldbigimg',
                        dataType:"html",
                        data:"article_id="+article_id,
                        success:function(msg)
                        {
        ...
        function deloldfile(article_id)
        {
            if(article_id!='') {
                swal({
                    ...
                    $.ajax({
                        type:"POST",
                        url:'/taokeyun.php/Article/deloldfile',
                        dataType:"html",
                        data:"article_id="+article_id,
                        success:function(msg)
                        {
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：内容管理 &raquo; 文章管理 &raquo; 编辑文章<a class="layui-btn pull-right" href="__CONTROLLER__/index/cat_id/{$msg['cat_id']}" style="margin-top: -10px">返回上一页 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
            </div>
        </div>
        <div class="layui-row layui-col-space15">
                ...
                <div class="layui-card">
                    <div class="layui-card-body">
                        <div class="layui-tab">
                            ...
                            <form action="__ACTION__/article_id/{$msg['article_id']}"  class="form-horizontal layui-form" method="post" enctype="multipart/form-data">
...
<!--                                <input type="hidden" name="oldfile" value="{$msg['file']}">-->
                                <input type="hidden" name="oldhref" value="{$msg['href']}">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="tab-1" class="tab-pane active" style="padding-top: 10px">
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="file" name="bigimg" accept="image/*" class="layui-input" style="width: 99%;">
                                            </div>
                                        </div>
<!--                                        <div class="layui-form-item">-->
...
<!--                                        </div>-->
                                        <div class="layui-form-item">
                                            <label class="layui-form-label" style="width: 120px;">上传新视频</label>
                                            <div class="layui-input-block">
                                                <input type="file" name="video" accept="video/*" class="layui-input" style="width:99%">
                                                <span class="layui-form-mid layui-word-aux">
                                                    上传的视频格式只支持mp4，大小限制50M<br>
                                                    外链视频请填写连接，上传视频则不用填写，同时填写则以上传视频为主
                                                </span>
                                            </div>
                                        </div>
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="text" class="layui-input" name="href" value="{$msg['href']}" placeholder="外链视频请填写连接，上传视频则不用填写，同时填写则以上传视频为主" style="width: 99%;">
                                            </div>
                                        </div>
                                        <div class="layui-form-item">
