        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：内容管理 &raquo; 文章管理 &raquo; 添加文章<a class="layui-btn pull-right" href="__CONTROLLER__/index/cat_id/{$cat_id}" style="margin-top: -10px">返回上一页 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
            </div>
        </div>
        <div class="layui-row layui-col-space15">
...
<!--                                        </div>-->
                                        <div class="layui-form-item">
                                            <label class="layui-form-label" style="width: 120px;">上传视频</label>
                                            <div class="layui-input-block">
                                        ...
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                <input type="text" class="layui-input" name="href" value="" placeholder="外链视频请填写连接，上传视频则不用填写，同时填写则以上传视频为主" style="width:99%">
                                            </div>
                                        </div>
                                        <div class="layui-form-item">
