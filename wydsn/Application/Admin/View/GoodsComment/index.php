...
function del(id)
{
	if(id!='') {
		swal({
			...
			$.ajax({
				type:"POST",
				url:'/taokeyun.php/GoodsComment/del',
				dataType:"html",
				data:"id="+id,
			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-content">
						<h3>当前位置： 商城系统 &raquo; 商品评论管理<a class="layui-btn pull-right" href="__MODULE__/Goods/index/cat_id/{$msg.cat_id}" style="margin-top: -10px">返回商品列表 <i class="fa fa-angle-double-right"></i></a></h3>
					</div>
					<div class="ibox-content">
