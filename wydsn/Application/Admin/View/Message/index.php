    ...
    <script type="text/javascript">
            ...
            $('#batchdel').click(function(){
                ...
                if(all_id!='') {
                    swal({
                        ...
                        $.ajax({
                            type:"POST",
                            url:"/taokeyun.php/Message/batchdel",
                            dataType:"html",
                            data:"all_id="+all_id,
        ...
        function changestatus(id,status)
        {
            if(id!='')
            {
                $.ajax({
                    type:"POST",
                    url:"/taokeyun.php/Message/changestatus",
                    dataType:"html",
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置： 内容管理 &raquo; 留言管理 &raquo; {$cat_title}<a class="layui-btn pull-right" href="__MODULE__/MessageCat/index" style="margin-top: -10px">返回留言分类列表 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
                <div class="ibox-content">
                    <div class="layui-row layui-col-space15">
