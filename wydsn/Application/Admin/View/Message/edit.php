        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：内容管理  &raquo; 留言管理 &raquo; 编辑留言<a class="layui-btn pull-right" href="__CONTROLLER__/index/cat_id/{$cat_id}" style="margin-top: -10px">返回留言列表 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
            </div>
        </div>
        <div class="layui-row layui-col-space15">
