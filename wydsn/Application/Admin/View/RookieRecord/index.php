        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置： 营销中心 &raquo; 拉新活动 &raquo; {$rname} 提现记录<a class="layui-btn pull-right" href="__MODULE__/Rookie/index" style="margin-top: -10px">返回上一页 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
                <div class="ibox-content">
