...
<!--                        <button class="layui-btn" type="submit">查询</button>-->
                    ...
                    <a class="layui-btn pull-right" href="__CONTROLLER__/add/cat_id/{$cat_id}">添加商品</a>
                    <div class="layui-row layui-col-space15">
...
<!--                                    <th width="23%">商品名称</th>-->
                                ...
                                <foreach name="goodslist" item="g">
                                    <tr>
                                        ...
                                        <td>{$g['goods_name']}</td>
                                        <td><?php if($g['shop_id']>0){?>多商户<?php }else{?>平台自营<?php }?></td>
                                        <td><?php if($g['shop_id']>0){?>商户名称:<?php echo $g['merchname'];?></br>用户ID:<?php echo $g['uid'];?></br>电话:<?php echo $g['mobile'];?><?php }?></td>
                                        <td>
                                            <?php if($g['shop_id']>0){?><?php echo $g['cat_info'];?><?php }?>
                                        </td>
                                        ...
                                        <td>
                                            <if condition='$g[is_show] eq Y'>
                                                ...
                                                <button type="button" class="layui-btn layui-btn-danger layui-btn-xs"
                                                        onclick="changeshow({$g.goods_id},'Y');"><?php echo ($g['sh'] == 1) ? "未审核" : '下架'?>
                                                </button>
                                            </if>
                                        </td>
                                        <td>
