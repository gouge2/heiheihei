        ...
        function del(id)
        {
            if(id!='') {
                swal({
                    ...
                    $.ajax({
                        type:"POST",
                        url:'/taokeyun.php/MessageCat/del',
                        dataType:"html",
                        data:"id="+id,
...
<!--                        <button class="btn btn-primary" type="submit">添加留言分类</button>-->
                            <div class="layui-form-item">
                                <label class="layui-form-label" style='width:120px'>留言分类名称</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="title" required  autocomplete="off" class="layui-input">
                                </div>
                                <div class="layui-input-inline">
                                    <button class="layui-btn layuiadmin-btn-admin"  lay-submit lay-filter="LAY-user-back-search">添加留言分类</button>
                                </div>
                            </div>
                    </form>
                    <div class="layui-row layui-col-space15">
                        <table class="layui-table">
                            ...
                            <foreach name="list" item="l">
                                <tr>
                                    ...
                                    <td>{$l['title']}</td>
                                    <td>{$l['createtime']}</td>
                                    <td><a href="__MODULE__/Message/index/cat_id/{$l.id}" class="layui-btn">点击查看留言列表</a></td>
                                    <td>
