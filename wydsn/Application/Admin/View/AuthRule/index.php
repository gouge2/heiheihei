        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="ibox-content">
                    <form action="__CONTROLLER__/addrule" method="post" role="form" class="form-inline pull-left layui-form">
                        ...
                        <div class="layui-inline">
                            <label class="layui-form-label" style='width:30px'>父级</label>
                            <div class="layui-input-inline">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" placeholder="" name="name" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
