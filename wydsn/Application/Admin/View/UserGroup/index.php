    ...
    <script type="text/javascript">
        function changestatus(id,status)
        {
            if(id!='')
            {
                $.ajax({
                    type:"POST",
                    url:"/taokeyun.php/UserGroup/changestatus",
                    dataType:"html",
        ...
        function del(id)
        {
            if(id!='') {
                swal({
                    ...
                    $.ajax({
                        type:"POST",
                        url:"/taokeyun.php/UserGroup/del",
                        dataType:"html",
                        data:"id="+id,
                        success:function(msg)
                        {
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="ibox-content">
                    <a class="layui-btn pull-left" href="__ROOT__/Public/Upload/User/user_sales.png" target="_blank">查看会员组体系/分销体系</a>
                        ...
                        <table class="layui-table">
                            ...
                            <foreach name="glist" item="g">
                                <tr>
                                    <td>{$g['id']}</td>
                                    <td>{$g['title']}</td>
                                    <td><img src="{$g['level_icon']}" height="30px"></td>
                                    <td>{$g['fee_user']}%</td>
                                    <td>{$g['fee_service']}%</td>
                                    ...
                                    <td><a href="__MODULE__/User/index/group_id/{$g.id}" class="layui-btn">点击查看会员列表</a></td>
                                    <td>
