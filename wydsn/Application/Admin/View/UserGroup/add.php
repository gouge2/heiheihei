        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：会员管理 &raquo; 会员组管理 &raquo; 新增会员组<a class="layui-btn pull-right" href="__CONTROLLER__/index" style="margin-top: -10px">返回上一页 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
            </div>
        </div>
        <div class="layui-row layui-col-space15">
                    ...
                    <div class="layui-card-body">
                        <form action="__ACTION__"  class="form-horizontal layui-form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="width: 150px;">用户会员组名</label>
                                <div class="layui-input-block">
                                    <input class="layui-input" name="title" placeholder="" style="width: 94%;">
                                    <div style="width: 94%;color: red">{$error1}</div>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="width: 150px;">上传等级图标</label>
                                <div class="layui-input-block">
                                    <input type="file" class="layui-input" name="level_icon" accept="image/*" value="" style="width: 94%;">
<!--                                    <div style="width: 94%;color: red">格式要求PNG，文件大小164x40px</div>-->
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="width: 150px;">等级必要经验</label>
                                <div class="layui-input-block">
                                    <input class="layui-input" name="exp" value="0" placeholder="" style="width: 94%">
                                </div>
                                <div class='layui-form-mid layui-word-aux'>从下一级会员组升级为本级会员组所需的最低经验，0为默认等级，请填写正整数</div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="width: 150px;">等级必要佣金</label>
                                <div class="layui-input-block">
                                    <input class="layui-input" name="commission" value="0" placeholder="" style="width: 94%">
                                </div>
                                <div class='layui-form-mid layui-word-aux'>
                                    从下一级会员组升级为本级会员组所需的最低佣金，0为不需要佣金限制。精确到分，如：8.88，单位元<br>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="radio" name="is_gift" value="Y" checked title='开启'>
                                    <input type="radio" name="is_gift" value="N" title='关闭'>
                                </div>
                                <div class='layui-form-mid layui-word-aux'>通过购买自营商城商品礼包升级为本级会员组</div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label" style="width: 150px;">礼包一级提成比例</label>
                                <div class="layui-input-block">
                                    <input class="layui-input" name="gift_referrer_tate" value="5" placeholder="" style="width: 94%;">
                                </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input class="layui-input" name="gift_referrer_tate2" value="3" placeholder="" style="width: 94%;">
                                </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input class="layui-input" name="time_limit" value="0" placeholder="" style="width: 94%;">   
                                </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input class="layui-input" name="discount" placeholder="" style="width: 94%;">
                                </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input class="layui-input" name="fee_user" value="60" placeholder="" style="width: 94%;">
                                </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input class="layui-input" name="fee_user_virtual" value="0" placeholder="" style="width: 94%;">
                                </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input class="layui-input" name="fee_service" value="10" placeholder="" style="width: 94%;">
                                </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input class="layui-input" name="fee_plantform" value="30" placeholder="" style="width: 94%;">
                                </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input class="layui-input" name="referrer_rate" value="30" placeholder="" style="width: 94%;">
                                </div>
                                <div class='layui-form-mid layui-word-aux'>请填写整数，30代表30%</div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input class="layui-input" name="referrer_rate_virtual" value="0" placeholder="" style="width: 94%;">
                                </div>
                                <div class='layui-form-mid layui-word-aux'>该参数用于提升app虚拟数据，不参与真实计算。请填写整数，10代表10%，不提升则填0</div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input class="layui-input" name="referrer_rate2" value="30" placeholder="" style="width: 94%;">
                                </div>
                                <div class='layui-form-mid layui-word-aux'>请填写整数，30代表30%</div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input class="layui-input" name="referrer_rate2_virtual" value="0" placeholder="" style="width: 94%;">
                                </div>
                                <div class='layui-form-mid layui-word-aux'>该参数用于提升app虚拟数据，不参与真实计算。请填写整数，10代表10%，不提升则填0</div>
                            </div>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item layui-layout-admin">
                                <div class="layui-input-block" style="width: 94%">
                                    <button type="submit" class="layui-btn"><i class="fa fa-check"></i>&nbsp;添加会员组</button>
