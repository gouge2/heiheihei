        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：拼多多管理系统 &raquo; 拼多多订单管理 &raquo; 查看订单详情<a class="layui-btn pull-right" href="__CONTROLLER__/index" style="margin-top: -10px">返回订单列表
                    ...
                    <div class="layui-card-body" style="overflow: hidden;">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" class="layui-input" disabled
                                       value="￥<?php echo $msg['goods_price'] / 100; ?>" style="width: 92%;">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" class="layui-input" disabled
                                       value="￥<?php echo $msg['order_amount'] / 100; ?>" style="width: 92%;">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" class="layui-input" disabled
                                       value="<?php echo $msg['promotion_rate'] / 10; ?>%" style="width: 92%;">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" class="layui-input" disabled
                                       value="￥<?php echo $msg['promotion_amount'] / 100; ?>" style="width: 92%;">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" class="layui-input" disabled
                                       value="￥<?php echo $msg['pdd_commission'] / 100; ?>" style="width: 92%;">
                            </div>
                        </div>
                        <div class="layui-form-item">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                ...
                                ?>
                                <input type="text" class="layui-input" disabled value="{$type_str}" style="width: 92%;">
                            </div>
                        </div>
                        <div class="layui-form-item">
