                                ...
                                <div>
                                    <div class="layui-input-block" style="width: 97%;">
                                        <input type="radio" name="task_info_award_type"
                                               value="1" <?php if ($msg['task_info_award_type'] == '1') echo 'checked'; ?> title='积分'>
                                        <input type="radio" name="task_info_award_type"
                                               value="2" <?php if ($msg['task_info_award_type'] == '2') echo 'checked'; ?> title='余额'>
                                        <input type="radio" name="task_info_award_type"
                                               value="3" <?php if ($msg['task_info_award_type'] == '3') echo 'checked'; ?> title='经验值'>
                                    </div>
                                </div>
                            </div>
                            <div class="layui-form-item">
