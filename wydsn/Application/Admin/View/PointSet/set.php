                                            ...
                                            <div style="padding-top: 7px">
                                                <div class="layui-input-block" style="width: 94%;">
                                                    <input type="radio" name="sign_award_type"
                                                           value="1" <?php if ($msg['sign_award_type'] == '1') echo 'checked'; ?> title='积分'>
                                                    <input type="radio" name="sign_award_type"
                                                           value="2" <?php if ($msg['sign_award_type'] == '2') echo 'checked'; ?> title='余额'>
                                                    <input type="radio" name="sign_award_type"
                                                           value="3" <?php if ($msg['sign_award_type'] == '3') echo 'checked'; ?> title='经验值'>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="layui-form-item">
                                            ...
                                            <div style="padding-top: 7px">
                                                <div class="layui-input-block" style="width: 94%;">
                                                    <input type="radio" name="sign_award_model"
                                                           value="1" <?php if ($msg['sign_award_model'] == '1') echo 'checked'; ?> title='固定'>
                                                    <input type="radio" name="sign_award_model"
                                                           value="2" <?php if ($msg['sign_award_model'] == '2') echo 'checked'; ?> title='连续'>
                                            </div>
                                        </div>
                                        </div>
                                        <div class="layui-form-item">
                                    ...
                                    <div id="tab-2" class="tab-pane" style="padding-top: 10px">
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                ...
                                                <span class="layui-form-mid layui-word-aux">注册赠送积分必须为不小于零的整数！</span>
                                            </div>
                                        </div>
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                ...
                                                <span class="layui-form-mid layui-word-aux" >推荐注册赠送积分必须为不小于零的整数！</span>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- 注册配置  -->
                                    ...
                                    <div id="tab-3" class="tab-pane" style="padding-top: 10px">
                                        <div class="layui-form-item">
                                            ...
                                            <div class="layui-input-block">
                                                ...
                                                <span class="layui-form-mid layui-word-aux">积分价值金额最小值不小于0.01</span>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- 费用配置  -->
