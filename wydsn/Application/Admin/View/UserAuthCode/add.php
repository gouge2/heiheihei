        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="ibox-content">
                    <h3>当前位置：会员管理 &raquo; 会员授权码管理 &raquo; 添加授权码<a class="layui-btn pull-right" href="__CONTROLLER__/index" style="margin-top: -10px">返回上一页 <i class="fa fa-angle-double-right"></i></a></h3>
                </div>
            </div>
        </div>
        <div class="layui-row layui-col-space15">
                        ...
                        <form action="__ACTION__"  class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" class="form-control" name="auth_code" placeholder="" style="width: 95%;"> 
                                </div>
                                <span class="layui-form-mid layui-word-aux">授权码长度为六位，请勿少于或超过</span>
                            </div>
