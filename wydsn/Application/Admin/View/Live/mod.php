                ...
                <div class="layui-card">
                    <div class="layui-card-body">
                        <form action=""  class="form-horizontal layui-form" lay-filter="mod_form" method="post" enctype="multipart/form-data">
                            ...
                            <?php 
                                if ($room['goods']['slg_id']) {
                                    foreach ($room['goods']['slg_id'] as $val) {
                                       echo "<input type=\"hidden\" name=\"slg_id[]\" value=\"". $val ."\">";
                                    }
                                }
                            ?>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline" style="width: 300px;margin:0">
                                    <input type="text" name="room_name" lay-verify="required" value="" placeholder="请输入房间名称" autocomplete="off" class="layui-input yc">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <select class="form-control yc" name="cat_id" lay-verify="required">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline" style="width: 110px;margin:0">
                                    <input type="text" name="user_str" lay-verify="required" value="" placeholder="请输入主播uid" autocomplete="off" class="layui-input yc">
                                </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline" style="width: 60%">
                                    <input type="text" name="cover_url" value="" placeholder="请上传视频封面图片" autocomplete="off" class="layui-input yc" lay-verify="required">
                                </div>
                                <button type="button" class="layui-btn yc" id="cover"><i class="layui-icon"></i>上传图片</button>
                                    ...
                                    <div class="layui-tab layui-tab-card">
                                        ...
                                        <div class="layui-tab-content" style="height: 100px;">
                                            ...
                                            <div class="layui-tab-item">
                                                <label class="layui-form-label" style="width: 90px;">视频地址</label>
                                                <div class="layui-input-inline" style="width: 80%;">
                                                    <input type="text" name="media_url" value="" placeholder="请输入视频地址" autocomplete="off" class="layui-input yc">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="layui-input-block">
                                    <?php
                                        foreach ($room['recommend'] as $k => $v) {
                                            ...
                                            echo '<input type="radio" name="is_recommend" value="'. $k .'" title="'. $v .'" '. $che .' class="yc">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <?php
                                        foreach ($room['status'] as $k => $v) {
                                            $che = (isset($room['is_status']) && $room['is_status'] == $k) ? 'checked="true"' : '';
                                            echo '<input type="radio" name="is_status" value="'. $k .'" title="'. $v['name'] .'" '. $che .' lay-filter="room_state" class="yc">
                                                  <div class="layui-unselect layui-form-radio layui-form-radioed">
                            ...
                            <div class="layui-form-item goods_div" style="display:none;">
                                <label class="layui-form-label" style="width: 130px;">讲解商品</label>
                                <div class="layui-input-inline" style="width: 60%">
                                    <div class="layui-tab layui-tab-card">
                                        <ul class="layui-tab-title">
                                        ...
                                        <div class="layui-tab-content" style="height: 100px;">
                                            <div class="layui-tab-item layui-show">
                                                ...
                                                <div class="layui-input-inline" style="width: 80%;">
                                                    <input type="text" name="goods[tb]" value="{$room.goods.tb}" placeholder="商品ID" autocomplete="off" class="layui-input yc">
                                                </div>
                                            </div>
                                            <div class="layui-tab-item">
                                                <label class="layui-form-label" style="width: 90px;">商品ID</label>
                                                <div class="layui-input-inline" style="width: 80%;">
                                                    <input type="text" name="goods[jd]" value="{$room.goods.jd}" placeholder="商品ID" autocomplete="off" class="layui-input yc">
                                                </div>
                                            </div>
                                            <div class="layui-tab-item">
                                                <label class="layui-form-label" style="width: 90px;">商品ID</label>
                                                <div class="layui-input-inline" style="width: 80%;">
                                                    <input type="text" name="goods[pdd]" value="{$room.goods.pdd}" placeholder="商品ID" autocomplete="off" class="layui-input yc">
                                                </div>
                                            </div>
                                            <div class="layui-tab-item">
                                                <label class="layui-form-label" style="width: 90px;">商品ID</label>
                                                <div class="layui-input-inline" style="width: 80%;">
                                                    <input type="text" name="goods[vip]" value="{$room.goods.vip}" placeholder="商品ID" autocomplete="off" class="layui-input yc">
                                                </div>
                                            </div>
                                            <div class="layui-tab-item">
                                                <label class="layui-form-label" style="width: 90px;">商品ID</label>
                                                <div class="layui-input-inline" style="width: 80%;">
                                                    <input type="text" name="goods[self]" value="{$room.goods.self}" placeholder="商品ID" autocomplete="off" class="layui-input yc">
                                                </div>
                                            </div>
                                            <div style="float:left; color:red;">注意：多个以中文的 “，” 逗号分开</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    let cover_show  = "{$room.cover_show}",   // 图片预览地址
        state       = "{$room.is_status}";     
    if (state == 1 || state == 2) {
        $(".yc").attr("disabled",true);
        $(".xsy").css("color","#5FB878");
    }
    // 后台直播div显示与隐藏
    if (state == 2) {   // 后台直播
        $(".goods_div").show();
    ...
    layui.use([], function() { 
        ...
        // 状态值改变
        form.on('radio(room_state)', function(data){
            state = data.value; //被点击的radio的value值
