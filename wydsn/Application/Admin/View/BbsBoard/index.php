    ...
    <script type="text/javascript">
        ...
        function changestatus(id,status)
        {
            if(id!='') {
                $.ajax({
                    type:"POST",
                    url:"/taokeyun.php/BbsBoard/changestatus",
                    dataType:"html",
                            ...
                            <table class="layui-table">
                                ...
                                foreach($list as $l) {
                                    ...
                                    echo '<tr class="'.$tr_class.'">
                                                ...
                                                <td>'.$l['createtime'].'</td>                                                
                                                <td><a href="__MODULE__/BbsArticle/checkPass/board_id/'.$l['board_id'].'"  class="layui-btn">查看帖子列表（'.$article_num.'篇）</a></td>
